...
Version  : 3.14.2
Release  : 2
URL      : https://github.com/nextcloud/desktop/archive/v3.14.2-original/desktop-3.14.2.tar.gz
Source0  : https://github.com/nextcloud/desktop/archive/v3.14.2-original/desktop-3.14.2.tar.gz
...
%prep
%setup -q -n desktop-3.14.2-original
cd %{_builddir}/desktop-3.14.2-original
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1729297905
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/desktop-%{version}-original/COPYING %{buildroot}/usr/share/package-licenses/nextcloud-desktop/4cc77b90af91e615a64ae04893fdffa7939db84c || :
cp %{_builddir}/desktop-%{version}-original/COPYING.documentation %{buildroot}/usr/share/package-licenses/nextcloud-desktop/8f545dc92cfddaf46764df9a77825bd3db01df11 || :
cp %{_builddir}/desktop-%{version}-original/cmake/modules/COPYING-CMAKE-SCRIPTS %{buildroot}/usr/share/package-licenses/nextcloud-desktop/ff3ed70db4739b3c6747c7f624fe2bad70802987 || :
cp %{_builddir}/desktop-%{version}-original/cmake/modules/Copyright.txt %{buildroot}/usr/share/package-licenses/nextcloud-desktop/756076d07b8eec7d83f8e90aacf4bfdcb2105114 || :
cp %{_builddir}/desktop-%{version}-original/src/3rdparty/QProgressIndicator/LICENSE %{buildroot}/usr/share/package-licenses/nextcloud-desktop/7c952efc81e54865f643a20cde021177a23e7ddd || :
cp %{_builddir}/desktop-%{version}-original/src/csync/COPYING %{buildroot}/usr/share/package-licenses/nextcloud-desktop/01a6b4bf79aca9b556822601186afab86e8c4fbf || :
cp %{_builddir}/desktop-%{version}-original/test/csync/COPYING %{buildroot}/usr/share/package-licenses/nextcloud-desktop/01a6b4bf79aca9b556822601186afab86e8c4fbf || :
export GOAMD64=v2
GOAMD64=v2
pushd clr-build
%make_install
...
/usr/lib64/libnextcloud_csync.so.3.14.2
/usr/lib64/libnextcloudsync.so.0
/usr/lib64/libnextcloudsync.so.3.14.2
