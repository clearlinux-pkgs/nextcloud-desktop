...
Version  : 3.15.2
Release  : 5
URL      : https://github.com/nextcloud/desktop/archive/v3.15.2/desktop-3.15.2.tar.gz
Source0  : https://github.com/nextcloud/desktop/archive/v3.15.2/desktop-3.15.2.tar.gz
...
%prep
%setup -q -n desktop-3.15.2
cd %{_builddir}/desktop-3.15.2
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735090473
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libnextcloud_csync.so.3.15.2
/usr/lib64/libnextcloudsync.so.0
/usr/lib64/libnextcloudsync.so.3.15.2
