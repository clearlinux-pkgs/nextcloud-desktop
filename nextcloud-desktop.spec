...
Version  : 3.15.3
Release  : 6
URL      : https://github.com/nextcloud/desktop/archive/v3.15.3/desktop-3.15.3.tar.gz
Source0  : https://github.com/nextcloud/desktop/archive/v3.15.3/desktop-3.15.3.tar.gz
...
%prep
%setup -q -n desktop-3.15.3
cd %{_builddir}/desktop-3.15.3
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736263771
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libnextcloud_csync.so.3.15.3
/usr/lib64/libnextcloudsync.so.0
/usr/lib64/libnextcloudsync.so.3.15.3
